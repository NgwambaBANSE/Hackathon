...
<br><br><br><br><br><br>
    ...
    <img class="imghead" width="80%" height="550px" src="Images/pexels-rodnae-productions-7648505.jpg" alt="">
  </div>
  <p class="lien1"><strong> L'un des meilleur programme d'apprentissage</strong></p>
    ...
    <div id="carouselExampleIndicators" class="carousel slide">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="imggroupe1" width="70%" height="500px" src="Images/Groupe 1.png" class="d-block imgformation "
            alt="...">
        </div>
